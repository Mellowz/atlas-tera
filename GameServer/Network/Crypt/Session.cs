...
namespace GameServer.Network.Crypt
{
    public class Session
    {
        ...
        public void Init()
        {
            TmpKey1 = Utils.ShiftKey(ServerKey1, /*31*/ 67);
            TmpKey2 = Utils.XorKey(TmpKey1, ClientKey1);

            TmpKey1 = Utils.ShiftKey(ClientKey2, /*17*/ 29, false);
            DecryptKey = Utils.XorKey(TmpKey1, TmpKey2);

            Decryptor.GenerateKey(DecryptKey);

            TmpKey1 = Utils.ShiftKey(ServerKey2, /*79*/ 41);
